      ...
      body: FutureBuilder<Map<String, dynamic>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            // Extract pHeart, pComment, pScript directly from data
            final int pHeart = data['pHeart'] ?? 0;
            final int pComment = data['pComment'] ?? 0;
            final int pScript = data['pScript'] ?? 0;
